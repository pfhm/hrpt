...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsLetter.published'
        db.add_column('reminder_newsletter', 'published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsLetter.published'
        db.delete_column('reminder_newsletter', 'published')
