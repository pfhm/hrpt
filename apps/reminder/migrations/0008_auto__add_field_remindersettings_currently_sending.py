...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReminderSettings.currently_sending'
        db.add_column('reminder_remindersettings', 'currently_sending', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReminderSettings.currently_sending'
        db.delete_column('reminder_remindersettings', 'currently_sending')
