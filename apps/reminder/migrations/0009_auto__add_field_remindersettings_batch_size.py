...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReminderSettings.batch_size'
        db.add_column('reminder_remindersettings', 'batch_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReminderSettings.batch_size'
        db.delete_column('reminder_remindersettings', 'batch_size')
